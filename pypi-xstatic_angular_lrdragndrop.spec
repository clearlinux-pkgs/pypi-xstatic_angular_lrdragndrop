...
cd %{_builddir}/XStatic-Angular-lrdragndrop-1.0.2.4
pushd ..
cp -a XStatic-Angular-lrdragndrop-1.0.2.4 buildavx2
cp -a XStatic-Angular-lrdragndrop-1.0.2.4 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671854329
